...
const liDecode = (decode) =>
  set_(/*@__NO_SIDE_EFFECTS__*/(buffer) => {
    const li = [],
      end = buffer.length;
    let pos = 0;
    while (pos < end) {
...
/*@__NO_SIDE_EFFECTS__*/
const v0_0 = (f) => set_(v0(f), 0);

/*@__NO_SIDE_EFFECTS__*/
const v0 = (f) => (buf) => f(buf, 0)[0];

const TEXT = new TextDecoder(),
  utf8d = /*@__NO_SIDE_EFFECTS__*/  (i) => TEXT.decode(i),
  get = (byteLength, attr) => {
    attr = "get" + attr;
    return (buf, pos = 0) => [
...
/*@__NO_SIDE_EFFECTS__*/
export const bytes = /*@__NO_SIDE_EFFECTS__*/set_(/*@__NO_SIDE_EFFECTS__*/(buf) => buf, new Uint8Array());

export const string = set_(/*@__NO_SIDE_EFFECTS__*/  utf8d, ""),
